...
Data Sciencetist, Ml Engineer, Android Dev - Malang, Indonesia

## Summary

An active and passionate computer science student in third year. Experience in developing Machine Learning Model, Processing Data and Developing Android App.

Passionate about continuously expanding my skills and knowledge in new languages and frameworks, especially within the Python ecosystem. Adept at collaborating in a team environment as well as mentoring programming to other.
Also actively teaching in labolatory of Brawijaya University. Some of the subjects that i have been teaching are :
- Basic Programming (Java, 2022)
- Object Oriented Programming (Java, 2023)
- Algorithm and Data Structure (Java, 2023)
- Computer Network (Teaching student how to build mini internet using framework by Networked Systems Group (NSG), 2023)

## Areas of Expertise

| Programming Languages                                  | Platforms / Frameworks / Libraries                       |
| ------------------------------------------------------ | -------------------------------------------------------- |
| PHP, Python 3.x                                        | Shopify, Shopify Theme + APIs                            |
| HTML5, CSS3                                            | Node.js, React.js                                        |
| Java, C++                                              | TypeScript, Express, Koa.js, Mongoose, JWT, GraphQL      |
| JavaScript, Kotlin                                     | jQuery, Bootstrap, Tailwind CSS, SCSS, Semantic UI       |
|                                                        | Flask (Python), Java Swing                               |
| <span className="font-semibold">Version Control</span> | <span className="font-semibold"> Languages</span>        |
| Git (GitHub, Gitlab)                                   | English, Indonesia (Native)                              |

## Working Experiences

### Weaverse

_Ha Noi, May 2022 - now_

**Project**: Weaverse - [https://apps.shopify.com/weaverse](https://apps.shopify.com/weaverse)
