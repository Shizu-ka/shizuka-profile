...
draft: false
summary: "Sometimes it is hard to understand what user wants from their searches. So today, we will try to make a hotel recommendation model to understand user's searches by mapping it to hotel tags."
